...
class JobDetails1 extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          appBAR(size,context),
          CardsDetail(size, "${data['companyUserName']}"),
        ],
      ),
    );
  }
  ...
  Widget CardsDetail(size, nameDevloper) {
  ...
  Widget CardsDetail2(context,size, nameDevloper, country, text) {
    return Container(
        ...
        margin: EdgeInsets.only(left: 2.h, right: 2.h, top: 37.h),
            ...
            children: [
              ...
              Padding(
                ...
                child: MaterialButton(
                    ...
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (_)=> FormData(data["companyID"],data["companyEmail"],data['companyUserName'],),),);
